import {GRAB_CALL_URL, GRAB_MODULE_ENV, GRAB_MODULE_OPTIONS, GRAB_MODULE_ENV_OPTIONS, GRAB_MODULE_PLAYERS, SET_MODULE, GRAB_MAPS, GRAB_MAP_CURRENT, GRAB_MODULE_CHAT} from '../actions/modules';

export default function module(state = {callURL: '', envOptions: [], environment: {name: ''}, key: '', envKey: '', moduleOptions: [], players: {}, name: '', maps: {}, currentMap: '', chat: {}}, action) {
	switch (action.type) {
		...
		case GRAB_CALL_URL:
			return {...state, callURL: action.data};
		default:
			return state;
	}
}